...
::: {.column width="50%"}
El objetivo de esta práctica es obtener un reporte con la legislación que sale a nivel nacional diariamente. Para ello, vamos a armar un [`scraper del BORA`](https://www.boletinoficial.gob.ar/seccion/primera)
:::
:::::
