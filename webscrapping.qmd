...
::::::: hero
::: hero-img
<img src="logo.png" alt="logo R en Buenos Aires"/>
:::
...
::: subtitle
R en Buenos Aires · Ariana Bardauil
:::
...
Cuando involucra datos personales, plantea desafíos legales y éticos.
::::
...
## 📜 Documentos sobre aspectos normativos y éticos del webscrapping {.smaller}
...
## 🌐 ¿Qué es el HTML de una página web ? {.smaller}
...
## 2° Aplicamos los mismos pasos dentro de un bucle {.smaller}
...
## 3 ° unimos todo y guardamos {.smaller}
